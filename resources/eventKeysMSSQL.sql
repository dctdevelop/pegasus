...
-- Deprecated Keys
-- georef_event varchar(10) default NULL,
-- georef_evinfo varchar(10) default NULL,
-- georef_evtype integer default NULL,
-- georef_id integer default NULL,
-- georef_name varchar(10) default NULL,
